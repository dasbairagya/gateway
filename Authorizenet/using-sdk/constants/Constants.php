...
class Constants
{
	...
	// const MERCHANT_LOGIN_ID = "292jEa2F6S7";
	// const MERCHANT_TRANSACTION_KEY = "6f7ZFzy9hLC2E54v";
	const MERCHANT_LOGIN_ID = "4x696GaEj";
	const MERCHANT_TRANSACTION_KEY = "76474B5tbHhb9TAL";
